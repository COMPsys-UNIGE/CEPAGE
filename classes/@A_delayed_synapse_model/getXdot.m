...
x_dot = zeros(2,1);
x_dot(1) = object.al*x(1)*(1-x(1))/(1+exp(-object.nu*(Vpre-object.theta)))-object.beta*x(1);
x_dot(2) = object.al*x(2)*(1-x(2))/(1+exp(-object.nu*(Vpreold-object.theta)))-object.beta*x(2);
end