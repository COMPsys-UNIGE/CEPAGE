...
for i=1:np
    xx = x(:,i);
    Vpre_ = Vpre(i); 
    J{i} = [ al*xx*(1-xx).*((object.nu./((1+exp(-object.nu*(Vpre_-object.theta))).^2)) - (object.nu./((1+exp(-object.nu*(Vpre_-object.theta)))))),...
            -al./(1+exp(-object.nu*(Vpre_-object.theta)))*(1-2*xx) - beta];
end
