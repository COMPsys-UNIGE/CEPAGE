classdef EIF_model < neuron_model
    ...
    %   _
    %  |
    %  | dv/dt = 0.04*v^2+5*v+140-u+I-gL(v-EL)-I_{ext}+gd*D*(V-EsynEx)
    % <
    %  | du/dt = a*(b*v-u);
    %  |_-
    %
    ...
    methods
        function obj = EIF_model(varargin)
            obj.nx = 2;
            obj.xnames = {'v','u'};
            obj.modelName = 'EIF';
            ...
            if nargin == 14
                ...
                obj.Vr = varargin{9};
                obj.tw = varargin{10};
                obj.gexp = varargin{11};
                obj.gd = varargin{12};
                obj.D = varargin{13};
                obj.EsynEx = varargin{14};
            end
        end
