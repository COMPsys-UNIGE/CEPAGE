classdef alpha_delayed_synapse_model < synapse_model
    ...
    methods
        %constructor
        function object = alpha_delayed_synapse_model(varargin)
            if nargin == 0
                object.nu = 0;
                object.theta = 0;
                object.al = 0;
                ...
                object.g1 = 0;
                object.nx = 2;
                object.modelName = 'alpha_delayed_synapse';
            ...
            elseif nargin == 6
                ...
                object.delays = varargin{5};
                object.g2 = varargin{6};
                object.g1 = 1;
                object.nx = 2;
                object.modelName = 'alpha_delayed_synapse';
                object.isContinuous = true;
