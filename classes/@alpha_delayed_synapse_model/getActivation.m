...
% act = object.g1*((object.al+object.beta)/object.al)*x1+object.g2*((object.al+object.beta)/object.al)*x2;
act = object.g1*((object.al+object.beta)/object.al)*x1 + object.g2*1./(1+exp(-object.nu*(varargin{2}(:,1)-(-50))));
% act = object.g1*((object.al+object.beta)/object.al)*x1 + object.g2*1./(1+exp(-object.nu*(varargin{2}(:,1)-object.theta)));
end
